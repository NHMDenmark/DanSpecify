...
In the **Loan Agents section**:

* Add **all** of the following agents to  the loan, choosing the appropriate **roles** from the drop-down menu and the correct **agent** from the query combo box:
1. Authoriser: 
2. Preparer:   
3. Receiver:   
4. Borrower:
