...
You can also communicate with the team and other end users by using the appropriate mailing list: 
 ...
 - For the Natural History Museum of Denmark: snmspecify@list.ku.dk ([sign up here]([url](https://list.ku.dk/postorius/lists/snmspecify.list.ku.dk/)))
 - For the other Danish natural history museums: danspecify@list.ku.dk ([sign up here]([url](https://list.ku.dk/postorius/lists/danspecify.list.ku.dk/)))
